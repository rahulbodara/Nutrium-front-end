...
const Footer = () => {
  ...
  return (
      <footer className='bg-footer-pattern md:bg-auto md:pt-[200px] md:bg-center relative bg-top bg-no-repeat h-[600px] bg-cover md:h-full'>
          <div className='w-[1040px] md:px-[20px] md:w-full absolute md:static left-0 right-0 bottom-0 xl:w-[900px] lg:w-[700px] mx-auto'>
              ...
              <div className=' flex md:flex-col justify-between mx-0 my-[50px]'>
                      ...
                      <div className='flex justify-start items-center lg:flex-wrap'>
                          <div className='lg:w-[33%] lg:mb-[15px]'>
                              <a href="#" target='_blank'>
                                  <Image src={competeImg} className="mr-[25px] object-contain w-full max-h-[25px] lg:w-auto lg:max-h-[35px]" />
                              </a>
                          </div>
                          <div className='lg:w-[33%] lg:mb-[15px]'>
                              <a href="#" target='_blank'>
                                  <Image src={fcqcImg} className="mx-[25px] object-contain w-full max-h-[25px] lg:w-auto lg:max-h-[35px]" />
                              </a>
                          </div>
                          <div className='lg:w-[33%] lg:mb-[15px]'>
                              <a href="#" target='_blank'>
                                  <Image src={norteImg} className="mx-[25px] object-contain w-full max-h-[25px] lg:w-auto lg:max-h-[35px]" />
                              </a>
                          </div>
                          <div className='lg:w-[33%] lg:mb-[15px]'>
                              <a href="#" target='_blank'>
                                  <Image src={portugalImg} className="mx-[25px] object-contain w-full max-h-[25px] lg:w-auto lg:max-h-[35px]" />
                              </a>
                          </div>
                          <div className='lg:w-[33%] lg:mb-[15px]'>
                              <a href="#" target='_blank'>
