                                            ...
                                            <form>
                                                <div className='workplace-modal flex'>
                                                    <div className='flex flex-col items-center justify-center mr-[24px]'>
                                                        ...
                                                        <div className='switcher' data-tooltip-id="tooltip-switch">
                                                ...
                                                <div className='mt-[32px] flex lg:flex-col items-center '>
                                                    <div className={`w-6/12 rounded px-3 lg:mb-[8px] lg:w-full py-[9px] ${associateAddress === 1 ? "text-[#1AB394] border-[#1AB394] " : "text-[#676a6c] border-[#dddddd]"}  bg-[rgba(255,255,255,0)] transition-all  duration-[0.5s] font-normal text-center whitespace-nowrap align-middle touch-manipulation cursor-pointer bg-none border text-sm leading-[1.42857143] select-none mb-0 border-solid`} onClick={() => handleAssociateAdd(1)}>
                                                    ...
                                                    <div className={`w-6/12 lg:ml-0 rounded px-3 lg:w-full py-[9px] ml-[4px] ${associateAddress === 2 ? "text-[#1AB394] border-[#1AB394] " : "text-[#676a6c] border-[#dddddd]"}  bg-[rgba(255,255,255,0)] transition-all  duration-[0.5s] font-normal text-center whitespace-nowrap align-middle touch-manipulation cursor-pointer bg-none border text-sm leading-[1.42857143] select-none mb-0 border-solid`} onClick={() => handleAssociateAdd(2)}>
