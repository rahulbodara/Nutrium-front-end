...
const SetShedule = ({ isSheduleOpen, setIsSheduleOpen }) => {
  ...
  const handleChange = (e) => {
    ...
    setFormData({
      ...formData,
      isEnabled: isAtLeastOneDayChecked,
      [name]: value,
    });
  };
  useEffect(() => {
                ...
                >
                  <Dialog.Panel className="w-full max-w-[600px] md:max-w-full transform overflow-hidden rounded bg-white  text-left align-middle shadow-xl transition-all">
                    <div className="p-[25px] relative">
                      <button
                        onClick={() => setIsSheduleOpen(false)}
                            ...
                            >
                              <div className="flex items-center">
                                <div className="flex-grow flex items-center">
                                  <div className="flex-grow flex items-center">
                                    <div className="flex-grow text-[#aaaaaa] text-[14px] font-[600]">
                                      {day.label}
                                    </div>
                                  </div>
                                ...
                                <div className="flex">
                                  <div className="flex flex-grow">
                                    <div className="flex-grow basis-0 mr-[10px] w-[100px]">
                                      <div className="text-[12px] font-light ml-[3px] mb-[3px]">
                                        Workplace
                                      </div>
                                      <div>
                                        <SelectField
                                    ...
                                    <div className="flex-grow basis-0 mr-[10px] w-[100px]">
                                      ...
                                      <div>
                                        <input
                                          type={"time"}
                                          className="text-[14px] h-[32px] p-[5px] rounded-[5px] border-solid !border-[#AAAAAA] text-center focus:ring-0 bg-white input-transition focus:!border-[#1ab394] w-full"
                                          name="startTime"
                                  ...
                                  >
                                    <div
                                      className="mt-[20px] ml-[10px] cursor-pointer"
                                      data-tooltip-id="minusIcon"
                                    >
                                      <Icon
