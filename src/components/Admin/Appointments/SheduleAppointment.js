...
import { mdiCalendarToday, mdiChevronDown, mdiDotsVertical, mdiLogout } from '@mdi/js'
    ...
    return (
        <div className='card-shadow bg-white mt-0 mb-[25px] relative p-0'>
            <div className='flex items-center p-[20px_20px_15px_20px] relative'>
                ...
                <div className='text-[1.1em] font-[300] md:hidden'>Today <span>at <span className='text-[1.2em] font-[400]'>4:04 PM</span></span></div>
                <div className='hidden md:block relative'>
                    <div className='px-[10px] -mx-[10px] cursor-pointer' onClick={toggleMenu}>
                        <Icon path={mdiDotsVertical} size={"24px"} />
                    </div>

                </div>
                <Menu isOpen={isOpen} setIsOpen={setIsOpen} options={moreOption} className="right-0 hidden md:block top-0" />
            </div>
            <div className='pt-[5px] p-[20px]'>
                <div className='flex md:flex-col md:relative'>
                    <div className='-mx-[20px] float-left mr-[20px] pl-[18px] border-l-[2px] md:border-l-[4px] border-[#1AB394] w-3/4 md:w-full relative '>
                        <div className='flex'>
                            <div className='mr-[15px] relative'>
                                <Link href={"#"}>
                                    <img src='/image/clientprof.png' className='max-w-[80px] min-h-[80px] rounded-full border-[1px] border-[#EEEEEE] h-auto' />
                                </Link>
                            </div>
                                ...
                                <div className='mt-[4px] font-[300] '>
                                    <div className='overflow-hidden whitespace-nowrap text-ellipsis text-[85%]'>
                                        <div className='flex gap-[4px] items-center'>
                                            <Icon path={mdiCalendarToday} color="#12896D" size={"11px"} className='w-[16px] h-[16px] rounded-full bg-[#E0FAF1] mr-[3px] align-middle justify-center' />
                    ...
                    <div className='w-1/4 md:mt-[20px] float-left md:w-full pl-[15px] md:p-0  relative md:static'>
                        <Link href="#" className={`mt-[5px] bg-[#1AB394] hover:bg-[#18a689] md:bg-[#d3f8eb] hover:border-[#18a689] text-white md:text-[#1AB394] md:mt-[5px] border-[#1AB394] rounded-[3px] block w-full text-xs leading-normal px-2.5 py-[5px] md:font-[600] md:uppercase md:p-[8px_10px] md:border-none text-center font-normal whitespace-nowrap align-middle touch-manipulation bg-none border select-none mb-0 border-solid border-transparent`}>Start</Link>
                        <div className="relative md:hidden">
                            <button className={`mt-[5px] rounded-[3px] w-full cursor-pointer bg-white border-[1px] text-[12px] border-[#d2d2d2] hover:border-[#eeeeee] leading-[1.5] p-[5px_10px] ${isOpen ? "focus:border-[#d2d2d2]" : ""}`} onClick={toggleMenu}>More options <Icon size={"12px"} className="inline" path={mdiChevronDown} /></button>
                            <Menu isOpen={isOpen} setIsOpen={setIsOpen} options={moreOption} className="left-0" />
                        </div>
                    </div>
                </div>
            </div>
