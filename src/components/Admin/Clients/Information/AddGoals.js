...
const AddGoals = (props) => {
    ...
    const ExampleCustomInput = forwardRef(({ value, onClick }, ref) => (
        <div onClick={onClick} ref={ref} className="flex relative items-center">
            <input value={value} className="flex-1 border w-full text-[13px]  ml-[-1px] focus:ring-0 focus:outline-none focus:border-[#EEEEEE] min-h-[34px] pr-[45px] py-[5px] px-[10px] border-[#EEEEEE]" />
            ...
            <Modal
                ...
                <div className="px-[30px] pt-[0] py-[20px]">
                    ...
                    <div className=" mt-[7px]">
                        ...
                        <select onChange={(e) => setGoalType(e.target.value)} className="border focus:shadow-none shadow-none focus:outline-none outline-none focus:ring-0 ring-0 transition-all duration-300 p-[6px_12px] w-full h-[34px] text-[13px] leading-4 focus:border-[#1ab394] border-[#e5e6e7]">
                            <option selected="selected" value="0">Generic (Sports and food routines, among others)</option>
                            <option value="1">Measured (Anthropometric data, Analytical Data, Body Composition)</option>
                            ...
                            <>
                                ...
                                <div className="grid mt-[25px] grid-cols-12 gap-[30px]">
                                    <div className="col-span-7">
                                        ...
                                        <input type="number" className="border focus:shadow-none shadow-none focus:outline-none outline-none focus:ring-0 ring-0 transition-all duration-300 p-[6px_12px] w-full h-[34px] text-[13px] leading-4 focus:border-[#1ab394] border-[#e5e6e7]" />
                                    ...
                                    <div className="col-span-5">
                                        ...
                                        <select className="border focus:shadow-none shadow-none focus:outline-none outline-none focus:ring-0 ring-0 transition-all duration-300 p-[6px_12px] w-full h-[34px] text-[13px] leading-4 focus:border-[#1ab394] border-[#e5e6e7]">
                                            <option selected="selected" value="0">kilogram</option>
                    ...
                    <div className=" mt-[15px]">
                        ...
                        <input placeholder="ex: Drink more than 1 liter of water per day" className="border focus:shadow-none shadow-none focus:outline-none outline-none focus:ring-0 ring-0 transition-all duration-300 p-[6px_12px] w-full h-[34px] text-[13px] leading-4 focus:border-[#1ab394] border-[#e5e6e7]" />
