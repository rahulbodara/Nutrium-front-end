...
import { mdiAccount, mdiAccountOutline, mdiAttachment, mdiCalendar, mdiCarSearch, mdiChevronDown, mdiDotsHorizontal, mdiDotsVertical, mdiFilterVariant, mdiLabelOutline, mdiMessageReplyText, mdiMessageText, mdiPackageDown, mdiPaperclip, mdiSearchWeb, mdiSend } from '@mdi/js'
...
const DynamicMessageChart = dynamic(() => import('@/components/Admin/Clients/C3Linechat'), { ssr: false });
...
export default function Conversations() {
  ...
  console.log(isOpen, 'setIsOpen==>>', setIsOpen)
      ...
      <MainLayout head={"Messages"} text={"Send, read and reply to messages from your clients."}>
        ...
        <div className='p-[25px_0_125px]'>
          <div className='-mx-[15px] flex xl:flex-wrap'>
            <div className='w-[66.66%] px-[15px] xl:order-2 xl:w-full'>
              <div>
                <div className='bg-[#FFFFFF] mb-[25px] mt-0 p-0 shadow-[(0_2px_2px_0_rgba(144,144,144,0.14))_(0_3px_1px_-2px_transparent)_(0_1px_5px_0_rgba(145,145,145,0.12))] rounded-[5px]'>
                  ...
                  <div className='pb-[15px] p-[0]'>
                    <div className='h-full p-[10px_0] bg-[#FAFAFB] border-t border-t-[#EEEEEE] border-b border-b-[#EEEEEE]'>
                      ...
                      <div className='max-w-[51%] xl:max-w-[85%] m-[5px_20px] relative'>
            ...
            <div className='w-[33.33%] px-[15px] xl:order-1 xl:w-full'>
              <div className='bg-[#FFFFFF] md:flex md:justify-between mb-[25px] mt-0 p-0 shadow-[(0_2px_2px_0_rgba(144_144_144_0.14))_(0_3px_1px_-2px_transparent)_(0_1px_5px_0_rgba(145_145_145_0.12))] rounded-[5px]'>
                <div className='rounded-[5px] bg-[#1AB394] md:bg-[#FFF] border-[0] text-[#FFFFFF] md:text-[#1AB394] p-[15px_20px] flex items-center sm:rounded-none'>
                    ...
                    <Dialog as="div" className="relative z-10" onClose={setOpen}>
                      ...
                      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                        <div className="flex items-end justify-center p-4 text-center sm:items-center sm:p-0">
                          ...
                          >
                            <Dialog.Panel className="relative transform overflow-hidden bg-white w-[900px] sm:w-[300px] lg:w-[600px] text-left shadow-xl transition-all sm:my-8 sm:p-6">
                              <div className="absolute right-0 top-0 pr-4 pt-4 flex flex-col border-[0] p-[25px] text-center ">
                                ...
                                >
                                  ...
                                  <XMarkIcon className="h-6 w-6 sm:h-4 sm:w-4" aria-hidden="true" />
                                </button>
                              </div>
                              <div></div>
                              <div className="">
                                <div className="text-center p-[25px] sm:p-0 sm:m-0 sm:text-center">
                                ...
                                <div className='p-[20px_30px] pt-0 relative sm:p-0'>
                                  <div className='flex gap-[28px] lg:flex-wrap lg:gap-0'>
                                    <div className='w-[50%] lg:w-full'>
                                      <div className='mb-[15px]'>
                                        <label className='inline-block max-w-[100%] mb-[5px] font-[700]'>Send to</label>
                                        <div className="relative table border-separate">
                                          <div className="p-[0_8px] min-w-[43px] border-r-[0] bg-[#fff] border border-[#e5e6e7] rounded-[1px] text-[14px] font-[400] leading-[1] text-center w-[1%] whitespace-nowrap align-middle table-cell">
                                            ...
                                            <Menu as="div" className="relative inline-block text-left w-full">
                                              ...
                                              >
                                                <Menu.Items className="absolute w-full mt-0 right-0 z-10 origin-top-right bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                  <div className=" m-[4px_4px_4px_0] max-h-[200px] p-[0_0_0_4px]">
                                                    <Menu.Item>
                                                      {({ active }) => (
                                                        <a
                                                          href="#"
                                                          className={classNames(
                                                            active ? 'bg-gray-100 text-[#676A6C]' : 'text-gray-700',
                                                            'block p-[5px_7px] text-sm bg-[#EEEEEE]'
                                                          )}
                                                        >
                                                          <span className='flex items-center'>
                                                            <span className='grow'>Example client</span>
                                                            <Icon path={mdiAccount} size={0.6} className='inline-block align-middle leading-[1]' />
                                                          </span>
                                                        </a>
                                                      )}
                                                    </Menu.Item>
                                    ...
                                    <div className='w-[50%] lg:w-full'>
                                      <div className='mb-[15px]'>
                                        <label className='inline-block max-w-[100%] mb-[5px] font-[700]'>Send to</label>
                                        <div className="relative table border-separate">
                                          <div className="p-[6px_12px] min-w-[43px] border-r-[0] bg-[#fff] border border-[#e5e6e7] rounded-[1px] text-[14px] font-[400] leading-[1] text-center w-[1%] whitespace-nowrap align-middle table-cell">
                                                    ...
                                                    <Menu.Item>
                                                      {({ active }) => (
                                                        <a
                                                          ...
                                                          className={classNames(
                                                            active ? 'bg-gray-100 text-[#676A6C]' : 'text-gray-700',
                                                            'block px-2 pt-1 text-[14px] bg-[#fff]'
                                                          )}
                                                        >
                                                          Appointment
                                                        </a>
                                  ...
                                  <div className="">
                                    <div className='w-full'>
                                      <div className='mb-[15px]'>
                                        <label className='inline-block max-w-[100%] mb-[5px] font-[700]'>Subject</label>
                                        <div className="relative table border-separate">
                                          <div className="p-[6px_12px] min-w-[43px] border-r-[0] bg-[#fff] border border-[#e5e6e7] rounded-[1px] text-[14px] font-[400] leading-[1] text-center w-[1%] whitespace-nowrap align-middle table-cell">
                                          ...
                                          <div>
                                            <input
                                              className="relative w-full flex-1 ring-0 focus:outline-none focus:ring-0 focus:border-[#EEEEEE] bg-white ml-[-1px] h-[38px] items-center border border-[#EEEEEE]"
                                              type="text"
                                              name="name"
                                            />
                                          </div>
                                    ...
                                    <div className='w-full'>
                                      <div className='mb-[15px]'>
                                        <label className='inline-block max-w-[100%] mb-[5px] font-[700]'>Message</label>
                                        <div className="relative table border-separate">
                                          <div>
                                            <textarea
                                              className="relative mb-[-5px] w-full flex-1 ring-0 focus:outline-none focus:ring-0 focus:border-[#EEEEEE] bg-white ml-[-1px] min-h-[56px] items-center border border-[#EEEEEE]"
                                              type="text"
                                              name="description"
                                              rows="5"
                                          ...
                                          <div className="p-[6px_12px] min-w-[43px] border-l-[0] bg-[#fff] border border-[#e5e6e7] rounded-[1px] text-[14px] font-[400] leading-[1] text-center w-[1%] whitespace-nowrap align-middle table-cell">
                                            <Icon path={mdiAttachment} size={0.8} className='-rotate-90' />
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                    <div className='mb-[15px] flex'>
                                      <div className='p-0 block my-[10px]'>
                                        <div className='relative inline-block mb-0 font-[400] align-middle '>
                                          <input type='radio' />
                                          <label className='inline-block align-middle relative pl-[5px] min-h-[20px] mb-0 font-[400] max-w-full'>Archive</label>
                                        </div>
                                      </div>
                                      <div className='p-0 block my-[10px] ml-[30px]'>
                                        <div className='relative inline-block mb-0 font-[400] align-middle '>
                                          <input type='radio' />
                                          <label className='inline-block align-middle relative pl-[5px] min-h-[20px] mb-0 font-[400] max-w-full'>Notify by email</label>
                                        </div>
                                      </div>
                                    </div>
                                    <div className="text-end mt-[20px] flex justify-between">
                                      <button onClick={() => setOpen(false)} className="bg-white  border rounded-[3px] text-[14px] px-[12px] py-[6px]">Cancel</button>
                                      <button className="bg-[#1AB394] ml-[5px] text-[#FFFFFF] rounded-[3px] text-[14px] px-[12px] py-[6px]">Send message</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
                  ...
                  <div>
                    <div>
                      <Icon path={mdiMessageText} size={0.8} className='inline-block align-middle leading-[1] md:hidden' />
                    </div>
                  </div>
                </div>
                <div className='p-[15px_20px] hidden md:block'>
                  <Icon path={mdiFilterVariant} size={1} className='text-[#676A6C]' />
                </div>
              </div>
              <div className='md:hidden'>
                <div className='w-full float-left xl:flex-wrap xl:flex xl:gap-[26px]'>
                  <div className='bg-[#FFFFFF] xl:w-[48%] mb-[25px] mt-0 p-[0] shadow-[(0_2px_2px_0_rgba(144_144_144_0.14))_(0_3px_1px_-2px_transparent)_(0_1px_5px_0_rgba(145_145_145_0.12))] rounded-[5px]'>
