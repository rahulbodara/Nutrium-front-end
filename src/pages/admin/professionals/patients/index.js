                            ...
                            <div className='p-[20px_20px_15px_20px]'>
                                <div className='flex items-center'>
                                    <div className='flex-1'>
                                        ...
                                        <span className='text-[12px] text-[#888888] font-thin block'>Check information about your clients</span>
                                    </div>
                                ...
                                <div className="pt-5 grid grid-cols-2 gap-7">
                                    ...
                                    <div className='flex border rounded-[1px] border-solid border-[#e5e6e7] hover:border-[#1AB394] p-[10px]'>
                                        ...
                                        <div className='flex flex-col flex-1 pl-3'>
                                            <h1 className='text-[16px] text-[#676a6c]'>Example client</h1>
                                            <span className='text-[13px] text-[#676a6c]'>Occupation example</span>
                                            <div className='flex gap-1 mb-1'>
                                                <div className='bg-[#E0FAF1] flex items-center justify-center w-4 h-4 rounded-full'>
                                                    <MdLocationOn className='text-[#12896D]' />
                                                </div>
                                                <span className='text-[11px] text-[#676a6c]'>Globalia</span>
                                            </div>
                                            <div className='flex gap-1'>
                                                <div className='bg-[#E0FAF1] flex items-center justify-center w-4 h-4 rounded-full'>
                                                    <IoMdCalendar className='text-[#12896D] scale-x-[-1]' />
                                                </div>
                                                <span className='text-[11px] text-[#676a6c]'>No appointments yet</span>
                                            </div>
                                        </div>
                                        <div className=''><FaUser className='text-[#AAAAAA]' /></div>
                                    </div>
                                    </Link>
                                    <div onClick={()=> setIsOpen(true)} className='border rounded-[1px] border-solid border-[#e5e6e7] group hover:border-[#1AB394] flex p-5 gap-6 text-center items-center '>
                                        <FaUserPlus className='scale-x-[-1] text-[#888888] group-hover:text-[#1AB394] text-[48px]' /> <span className='text-[16px] group-hover:text-[#1AB394] text-[#888888] font-normal'>Add new client</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='flex flex-col  gap-5'>
                        <div className='bg-white shadow-box1 rounded p-[20px]'>
                            <div>
                                ...
                                <span className='text-[12px] text-[#888888] mb-5 block'>Filter which clients you want to see</span>
                                <div>
                                    <select
                        ...
                        <div className='bg-white shadow-box1 rounded p-[20px]'>
                            <div>
                                <h1 className=' text-[20px] text-[#676a6c] '>General information</h1>
                                <span className='text-[12px] text-[#888888] mb-5 block'>Check statistics on new and active clients</span>
                                <h2 className='font-[400] text-[#676a6c] text-[24px]'>0 of 1</h2>
                                <div className='flex mb-2 mt-1'>
                                    <span className='text-[12px] text-[#888888]  flex-1'>Active clients compared to total number</span>
                                ...
                                <div className='bg-[#f5f5f5] transition rounded-full overflow-hidden w-full h-[5px]'>
                                    <div className='bg-[#1ab394] h-[5px]' style={{ width: '0%' }}></div>
                                </div>
                                <h2 className='font-[400] text-[#676a6c] mt-[15px] text-[24px]'>0</h2>
                                <div className='flex mb-2 mt-1'>
                                    <span className='text-[12px] text-[#888888]  flex-1'>New clients this month</span>
                                    <span className='text-[12px] flex items-center  text-[#888888] gap-1'><BiTrendingDown className='text-[18px]' /> 100.0%</span>
                        ...
                        <div className='bg-white shadow-box1 rounded p-[20px]'>
                            ...
                            <span className='text-[12px] text-[#888888] mb-5 block'>Clients added in the last 6 weeks</span>
                            <div>
                                <NewClientsChart />
                            </div>
                        </div>
                        <div className='bg-white shadow-box1 rounded p-[20px]'>
                            ...
                            <span className='text-[12px] text-[#888888] mb-5 block'>Check the age distribution of your active clients</span>
                            <div>
                                <AgeChart />
                            </div>
                        </div>
