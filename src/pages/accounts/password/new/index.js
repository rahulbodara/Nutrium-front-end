...
const Forgot_password = () => {
  return (
    <SignupBody>
        <div className={`my-[80px] bg-white rounded-[5px] max-w-[900px] md:max-w-[100%] mx-auto md:m-[20px_20px_100px] xl:max-w-[75%] xl:my-[50px] xl:mx-auto`}>
            <div className='p-[40px] md:p-[20px]'>
                <h1 className=' text-3xl text-[#1AB394] md:text-[26px] tracking-[0.5px] text-center md:text-left'>Forgot your password?</h1>
            </div>
            <div className='p-[0_40px_40px] md:p-[0_20px_20px] flex md:flex-col'>
                ...
                <div className='p-[40px] md:p-0 flex-1'>
                    <p>Enter your registration email to receive instructions to change your password.</p>
                    <p className='mb-[20px]'>Forgot which email address you signed up with? <span><a href="#" className='clr-grn underline'>Send us an email.</a></span></p>
                    <div className="mb-[15px]">
                      ...
                      <Button type='button' className="capitalize w-full mt-[24px]">Send instructions</Button>
