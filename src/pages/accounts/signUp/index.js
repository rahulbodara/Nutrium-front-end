...
const Sign_in = () => {
  ...
  console.log("🚀 ~ file: index.js:20 ~ signupStep:", signupStep)
  ...
  return (
    <>
      <SignupBody>
        <div className={`my-[80px] mx-auto ${signupStep === 2 || signupStep === 3 ? 'max-w-[750px] max-md:max-w-[100%]' : 'max-w-[900px] max-md:max-w-[100%]'} rounded  max-xl:max-w-[75%] max-xl:my-[50px] max-xl:mx-auto`}>
          <div className="flex">
            <form className="w-full">
              <div className="block w-full overflow-hidden">
                <div className="flex">
                  ...
                  <section className={`p-[80px] max-md:p-[40px] bg-white relative flex-shrink-0 w-full ${signupStep === 2 ? '-left-[900px] hidden': signupStep === 3 ? '-left-[900px] hidden': 'left-0 block'}`}>
                    ...
                    <div className="flex">
                      ...
                      <div className="py-[15px] px-[64px] pr-0 border-l-[1px] border-l-[#e0faf1] flex-1 max-lg:pl-[0]">
                        ...
                        <Button type='button' className="capitalize w-full mt-[24px]" onClick={() => setSignupStep(2)}>sign up</Button>
                  ...
                  <section className={`p-[80px] max-md:p-[40px] w-full relative bg-white ${signupStep === 2 ? 'left-[0] block': '-left-[900px] hidden'} `}>
                        <div className='mb-[40px]'>
                        ...
                        <div>
                            <label htmlFor="" className='inline-block max-w-full text-[13px] mb-[5px] text-[#676a6c]'>Date of Birth</label>
                            <div className='mb-[15px]'>
                                <input placeholder='MM/DD/YYYY' inputMode='text' className='w-full h-[34px] placeholder:text-[15px] text-[#676a6c] placeholder:text-[#676a6c42] border-[1px] rounded-[3px] border-[#aaaaaa] focus:placeholder:text-[#676a6c] focus:border-[#1AB394] focus-visible:!outline-none focus:border-[1px] focus:bg-transparent p-[8px] ' />
                            </div>
                        </div>
                        <div>
                            <label htmlFor="" className='inline-block max-w-full text-[#676a6c] text-[13px] mb-[5px]'>Mobile Phone</label>
                            <div className='mb-[15px] flex'>
                                ...
                                <input placeholder='insert your mobile phone number' inputMode='text' className='h-[34px] text-[#676a6c] placeholder:text-[#676a6c42]   w-full border-[1px] rounded-l-[0px] rounded-r-[3px] border-[#aaaaaa] focus:border-[#1AB394] focus-visible:!outline-none focus:border-[1px] focus:bg-transparent p-[8px] ' />
                            </div>
                        </div>
                        <div className=''>
                            <Select searchOption={false} label="Profession" />
                        </div>
                        <Button type='button' className="capitalize w-full mt-[24px]" onClick={() => setSignupStep(3)}>Continue</Button>
                    </section>
                  ...
                  <section className={`p-[80px] max-md:p-[40px] w-full relative bg-white ${signupStep === 3 ? 'left-[0] block': '-left-[900px] hidden'} `}>
                        <div className='mb-[40px]'>
                            <h1 className=' text-3xl text-[#1AB394] tracking-[0.5px] text-center'>Last step to start using Nutrium!</h1>
                        </div>
                        <div className='mb-[15px]'>
                            <Select searchOption={false} label="What are you looking for in Nutrium?" />
                        </div>
                        <div className='mb-[15px]'>
                            <label htmlFor="workspace" className='text-[#676a6c] text-[13px]'>Workspace</label>
                            <input type="text" className='w-full text-[13px] focus:outline-none border-[1px] border-[#aaa] rounded-[3px] h-[34px] p-[8px] text-[#676a6c] focus:border-[#1AB394] placeholder:text-[#676a6c42]' id='Workspace' placeholder='E.g.Nutrium practice:Online practice' />
                        </div>
                        <div className='mb-[15px]'>
                            <MultiSelect options={options} onChange={handleMultiSelectChange} label="Expertise" />
                        </div>
                        
                        <div className='mb-[15px]'>
                            <label className='text-[#676a6c] text-[13px]'>Average number of clients per month</label>
                            <div className='grid grid-cols-[1fr_1fr_1fr_1fr] max-md:grid-cols-[1fr_1fr] max-md:gap-y-[1em] auto-rows-[1fr] gap-x-[1em]'>
                                <span>
                                    <label htmlFor='radio1' className='flex justify-center items-center h-full w-full radio-pill'>
                                        <input type="radio" id='radio1' name='monthlyclient' className='hidden' />
                                        <label className='rounded p-[1em] max-md:p-[0.5em] flex items-center justify-center border border-[#AAAAAA] text-[#AAAAAA] text-[13px] w-full text-center hover:bg-[#EEEEEE] h-full cursor-pointer' htmlFor='radio1'>No clients</label>
                                    </label>
                                </span>
                                <span>
                                    <label htmlFor='radio2' className='flex justify-center items-center h-full w-full rounded radio-pill'>
                                        <input type="radio" id='radio2' name='monthlyclient' className='hidden' />
                                        <label className='rounded p-[1em] max-md:p-[0.5em] flex items-center justify-center border border-[#AAAAAA] text-[#AAAAAA] text-[13px] w-full text-center hover:bg-[#EEEEEE] h-full cursor-pointer' htmlFor='radio2'>Up to 10</label>
                                    </label>
                                </span>
                                <span>
                                    <label htmlFor='radio3' className='flex justify-center items-center h-full w-full rounded radio-pill'>
                                        <input type="radio" id='radio3' name='monthlyclient' className='hidden' />
                                        <label className='rounded p-[1em] max-md:p-[0.5em] flex items-center justify-center border border-[#AAAAAA] text-[#AAAAAA] text-[13px] w-full text-center hover:bg-[#EEEEEE] h-full cursor-pointer' htmlFor='radio3'>Up to 25</label>
                                    </label>
                                </span>
                                <span>
                                    <label htmlFor='radio4' className='flex justify-center items-center h-full w-full rounded radio-pill'>
                                        <input type="radio" id='radio4' name='monthlyclient' className='hidden' />
                                        <label className='rounded p-[1em] max-md:p-[0.5em] flex items-center justify-center border border-[#AAAAAA] text-[#AAAAAA] text-[13px] w-full text-center hover:bg-[#EEEEEE] h-full cursor-pointer' htmlFor='radio4'>More than 25</label>
                                    </label>
                                </span>
                            </div>
                        </div>
                        <button className='w-full border-[1px] rounded-[3px] text-[#fff] text-[14px] bg-[#EA9F77] py-[6px] px-[12px] mt-[24px]' name='button' type='button'>Access Nutrium</button>
                    </section>
